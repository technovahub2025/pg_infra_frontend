    ...
    >
      <div className="relative hidden min-h-screen overflow-hidden bg-[#0F2236] lg:flex lg:flex-col lg:justify-center">
        ...
        <div className="relative mx-auto flex w-full max-w-md flex-col items-start gap-8 px-10">
          <img src={logo} alt="ZEROWALL" className="h-16 w-16" />
          <div>
            <p className="font-display text-4xl font-bold tracking-tight text-white">ZEROWALL</p>
            <p className="mt-3 text-lg text-slate-300">Built for those who never miss.</p>
          </div>
      ...
      <div className="relative flex min-h-screen items-center justify-center px-5 py-10 sm:px-8">
        ...
        >
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-slate-400">Sign in to ZEROWALL</p>
          </div>
          <LoginForm />
